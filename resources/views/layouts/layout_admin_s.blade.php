...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>iPACK Speaking | Teacher</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="logo-box">
                        <a href="{{url('/admin_home')}}" class="logo text-center">
                            <span class="logo-lg">
                                <span class="logo-lg-text-light">iPACK Speaking</span>
                            </span>
                            <span class="logo-sm">
                        ...
                        <ul class="navigation-menu  d-lg-flex justify-content-center">
                            ...
                            <li class="has-submenu">
                                <a href="{{ url('/speaking/dashboard') }}" class="text-light">
                                    <i class="fas fa-folder-plus"></i>All Speaking
                                </a>
                            </li>
                            ...
                            <li class="has-submenu">
                                <a href="{{ route('manage') }}" class="text-light">Manage</a>
                            </li>
                            @endif
