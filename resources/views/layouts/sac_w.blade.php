...
<html lang="en">
    ...
    <body class="unsticky-header">
        ...
        <div class="navbar-custom bg-white">
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list mt-3">
                            <span class="badge badge-warning font-13 p-1">Writing point  {{ \App\Model\PointsWriting::checkPoint() }} points</span>
                        </li>
            ...
            <div class="topbar-menu border-bottom border-left border-right border-white border-3 bg-warning">
                <div class="container-fluid">
