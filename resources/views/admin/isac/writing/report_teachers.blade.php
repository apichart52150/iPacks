...
<div class="row">
	<div class="col-lg-12">
		<div class="card-box">
			...
			<div class="row my-3">
				<div class="col-lg-10">
					<form role="form" action="{{ route('report_writing_teachers') }}" method="post">
						{{ csrf_field() }}
			...
			<table class="table table-bordered table-striped" id="report_writing">
				<thead>
					<tr>
						<th>#</th>
						<th>TEACHER NAME</th>
						...
						<tr>
							...
							<td>
								...
								<b class="badge badge-pill badge-warning">
									<a href="{{ route('teacher_writing.pending', [$value['user_id']]) }}">{{ $value['pending'] }}</a>
								</b>
								@else
...
@if($route == 'writing/report/teachers')
	...
	<script>
		$(function () {
			...
			$('#report_writing_wrapper').removeClass('container-fluid');
