...
<div class="card-box pt-0">
	<div class="row justify-content-center">
		<div class="col-md-6 card-body">
			...
			<div class="card">
				<div class="card-header bg-primary text-white text-center p-1">{{ $check['topic'] }}</div>
				<div class="card-body">
			...
			<div class="col-md-12 pl-0">
				<div class="media mb-4 mt-1">
                    ...
                    <div class="media-body">
                        ...
                        <h6 class="m-0 font-15 text-primary mb-1">{{ $check['std_name'] }}</h6>
                        <small class="text-dark font-14"><b><u>Course</u></b> : {{ $check['coursename'] }} <b class="ml-2"><u>Teacher</u></b> : {{ $check['th_inClass'] }}</small>
                        <div class="text-dark">
                        	<span><b><u>Expected Score</u> :</b> {{ $check['expected_score'] }}</span>
                        	<span class="ml-2"><b><u>Current Course</u> :</b> {{ $check['current_course'] }}</span>
                        </div>
                    </div>
                </div>
			</div>
