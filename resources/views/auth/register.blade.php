	...
	<div class="modal-dialog modal-full modal-dialog-scrollable" role="document">
		<div class="modal-content">
			...
			<ol class="text-muted" style="line-height: 2em;">
				...
				<!-- 8 -->
				<li>
				ถ้าหากผู้เรียนทราบหรือสงสัยว่าบุคคลอื่นใด (นอกจากทางสถาบันและผู้เรียน) ทราบรหัสผู้ใช้ หรือ รหัสผ่านของท่าน ผู้เรียนต้องแจ้งทางสถาบันทันทีที่อีเมล info@newcambridge.com
				</li>
				<!-- 9 -->
				<li>
				...
				<!-- 11 -->
				<li>
				ทางสถาบันขอสงวนสิทธิ์ในการเปลี่ยนแปลงอาจารย์ เวลาเรียน และช่องทางการเรียนออนไลน์ และการรวมชั้นเรียน ในกรณีดังต่อไปนี้
				<ul>
					<li>
				...
				<!-- 13 -->
				<li>
				ผู้เรียนต่อห้องมีจำนวนมากที่สุดไม่เกิน 18 ท่าน ในบางโอกาสจำนวนผู้เรียนต่อห้องอาจมากกว่ากำหนดเป็นการชั่วคราว เนื่องจากมีการยักย้ายผู้เรียนตามเหตุจำเป็น
				</li>
				<!-- 14 -->
				<li>
				...
				<ul>
					...
					<li>
					แจ้งทางสถาบันในกรณีที่ท่านไม่สามารถเข้าเรียน ไม่ว่าด้วยเหตุใดก็ตาม โดยต้องแสดงเอกสาร หรือ หลักฐานของสาเหตุการไม่สามารถเข้าเรียนครั้งนั้น
					</li>
					<li>
				...
				<!-- 28 -->
				<li>
				ถ้าหากผู้เรียนประสบปัญหาเกี่ยวกับการให้บริการของสถาบัน หรือ ประสงค์ติดต่อสถาบัน โปรดส่งอีเมลมาที่ info@newcambridge.com
				</li>
				<!-- 29 -->
				<li>
				ถ้าหากผู้เรียนประสบปัญหาเกี่ยวกับการให้บริการของสถาบัน หรือ ประสงค์ติดต่อสถาบัน โปรดส่งอีเมลมาที่ info@newcambridge.com
