...
@section('content')
	...
	<div class="content">
		<div class="container-fluid" onload="LoadModal();">
			<div class="row">
				<div class="col-md-12">
					<div class="card-box">
						...
						<form action="{{ route('fn_gateway_listening') }}" id="basic-form" method="POST" class="mt-3" onsubmit="return confirm('Are you sure you want to finish?')">
							{{ csrf_field() }}
