@extends('layouts.headerieltswriting')
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card-box">
					<div class="row">
						<div class="col-6"><h4 class="header-title"><b>Gateway To IELTS : Writing</b></h4>
					...
					<form action="{{ route('fn_gateway_writing') }}" id="basic-form" method="POST" class="mt-3" onsubmit="return confirm('Are you sure you want to finish?')">
						{{ csrf_field() }}
						...
						<div>
							...
							<h3>Writing Task 1 General Training</h3>
							<section>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
...
@section('javascript')
<script src="{{ asset('public/js/timer_ieltswriting.js') }}"></script>
@stop