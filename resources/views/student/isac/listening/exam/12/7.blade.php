...
$E1_1_5->e1->q = "Why does the crocodile have to lie in the sun?";
$E1_1_5->e2->q = "How long can the female crocodile grow?";
$E1_1_5->e3->q = "What makes them strong swimmers?";
$E1_1_5->e4->q = "What will crocodiles NOT eat?";
$E1_1_5->e5->q = "Where’s the best place for crocodile skin?";

$E1_1_5->e1->aw = "B. It has cold blood.";
$E1_1_5->e2->aw = "C. Around three and a half meters";
$E1_1_5->e3->aw = "A. Their strong tails";
$E1_1_5->e4->aw = "C. Plants";
$E1_1_5->e5->aw = "C. On a living crocodile";
...
$E1_1_5->e1->choice->a = "A. It’s so big.";
$E1_1_5->e1->choice->b = "B. It has cold blood.";
$E1_1_5->e1->choice->c = "C. It lives in the water.";
$E1_1_5->e2->choice->a = "A. Over seven meters long";
$E1_1_5->e2->choice->b = "B. Almost as big as the male";
$E1_1_5->e2->choice->c = "C. Around three and a half meters";
$E1_1_5->e3->choice->a = "A. Their strong tails";
$E1_1_5->e3->choice->b = "B. Their excellent sense of smell";
$E1_1_5->e3->choice->c = "C. The fact they can live as long as one hundred years";
$E1_1_5->e4->choice->a = "A. Other animals";
$E1_1_5->e4->choice->b = "B. People";
$E1_1_5->e4->choice->c = "C. Plants";
$E1_1_5->e5->choice->a = "A. On a bag";
$E1_1_5->e5->choice->b = "B. On a pair of shoes";
$E1_1_5->e5->choice->c = "C. On a living crocodile";
...
$E2_1_5->e1->q = "Where can saltwater crocodiles be found?";
$E2_1_5->e2->q = "Name three reptiles from the passage.";
$E2_1_5->e3->q = "How long can they stay under the water?";
$E2_1_5->e4->q = "How many eggs does the female lay at one time?";
$E2_1_5->e5->q = "What is the greatest danger for these crocodiles?";

$E2_1_5->e1->aw = "Asia, New Guinea, Australia, America and Africa";
