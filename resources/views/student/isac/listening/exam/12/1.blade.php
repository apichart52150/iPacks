...
$E1_1_5->e1->q = "Which of the following is TRUE?";
$E1_1_5->e2->q = "What do we know for certain about this cockroach? ";
$E1_1_5->e3->q = "What is unusual about the female hissing cockroach? ";
$E1_1_5->e4->q = "In what way is this insect different from other cockroaches? ";
$E1_1_5->e5->q = "Why do teachers and students choose this insect to study at school? ";

$E1_1_5->e1->aw = "C. It lives only on an island near Africa.";
$E1_1_5->e2->aw = "A. It makes a sound.";
$E1_1_5->e3->aw = "B. It doesn’t lay eggs.";
$E1_1_5->e4->aw = "A. It doesn’t have wings.";
...
$E1_1_5->e1->choice->a = "A. The hissing cockroach looks like a snake.";
$E1_1_5->e1->choice->b = "B. It can be found all over the world.";
$E1_1_5->e1->choice->c = "C. It lives only on an island near Africa.";
$E1_1_5->e2->choice->a = "A. It makes a sound.";
$E1_1_5->e2->choice->b = "B. It lives in dead trees.";
$E1_1_5->e2->choice->c = "C. It eats fruit.";
$E1_1_5->e3->choice->a = "A. It lays about 30 – 60 eggs.";
$E1_1_5->e3->choice->b = "B. It doesn’t lay eggs.";
$E1_1_5->e3->choice->c = "C. It is not so different from other cockroaches.";
$E1_1_5->e4->choice->a = "A. It doesn’t have wings.";
$E1_1_5->e4->choice->b = "B. It doesn’t live as long as other cockroaches.";
$E1_1_5->e4->choice->c = "C. It can fly but it doesn’t have wings.";
$E1_1_5->e5->choice->a = "A. Because it is so different from other cockroaches.";
$E1_1_5->e5->choice->b = "B. Because it is easy to look after.";
...
$E2_1_5->e1->q = "Where is Madagascar?";
$E2_1_5->e2->q = "What does the cockroach probably eat?";
$E2_1_5->e3->q = "What is most unusual about this insect?";
$E2_1_5->e4->q = "How many babies can a female produce at one time?";
$E2_1_5->e5->q = "Why is this a good insect for students to study in class? (give 3 reasons)";

$E2_1_5->e1->aw = "off the coast of Africa";
$E2_1_5->e2->aw = "fruit";
