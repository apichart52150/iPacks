...
$E1_1_5->e1->q = "What do we know about the private policemen?";
$E1_1_5->e2->q = "In those cities where private policemen protect the streets, …";
$E1_1_5->e3->q = "How do senior police officers feel about having private policemen?";
$E1_1_5->e4->q = "Why do some parts of town NOT have private policemen?";
$E1_1_5->e5->q = "The number of crimes is usually higher in….";

$E1_1_5->e1->aw = "B. They sometimes have dogs with them.";
$E1_1_5->e2->aw = "B. the number of crimes has deceased.";
$E1_1_5->e3->aw = "C. They know there are good points and bad points.";
$E1_1_5->e4->aw = "A. They don’t have enough money to pay for them.";
$E1_1_5->e5->aw = "C. poor parts of town.";
...
$E1_1_5->e1->choice->a = "A. They usually work alone.";
$E1_1_5->e1->choice->b = "B. They sometimes have dogs with them.";
$E1_1_5->e1->choice->c = "C. They don’t cost very much.";
$E1_1_5->e2->choice->a = "A. the number of crimes has increased.";
$E1_1_5->e2->choice->b = "B. the number of crimes has deceased.";
$E1_1_5->e2->choice->c = "C. people are not very happy with the results.";
$E1_1_5->e3->choice->a = "A. They don’t want them at all.";
$E1_1_5->e3->choice->b = "B. They think they’re a very good idea.";
$E1_1_5->e3->choice->c = "C. They know there are good points and bad points.";
$E1_1_5->e4->choice->a = "A. They don’t have enough money to pay for them.";
$E1_1_5->e4->choice->b = "B. Private policemen are too dangerous.";
$E1_1_5->e4->choice->c = "C. Private policemen will not work there.";
$E1_1_5->e5->choice->a = "A. areas where the private policemen work.";
$E1_1_5->e5->choice->b = "B. rich parts of town.";
$E1_1_5->e5->choice->c = "C. poor parts of town.";
...
$E2_1_5->e1->q = "How do the private guards protect the neighbourhood?";
$E2_1_5->e2->q = "Why are people happy with the private policemen?";
$E2_1_5->e3->q = "Why are senior police officers happy with the private guards?";
