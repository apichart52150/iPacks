                            ...
                            <div class="col-md-12">
                                <table class="w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$caller_4->q}}</td>
                                        <td class="pr-4">
                                            <select id="q-probability" class="form-control q-text" show-aw="caller_4-{{$index}}" aw="{{$caller_4->aw}}">
                                        ...
                                        <td>
                                            <div class="input-con w-75">
                                                <div class="dropbox q w-100" show-aw="caller_42-{{$index}}" aw="{{$caller_4->aw2}}"></div>
                                            </div>
                                            <br>
