...
$E1_1_5->e1->q = "How does the doctor see inside the patient’s body?";
$E1_1_5->e2->q = "How can the doctor cut away the damaged part of the body?";
$E1_1_5->e3->q = "Why is this kind of operation known as a ‘keyhole’ operation?";
$E1_1_5->e4->q = "Which of these is TRUE?";
$E1_1_5->e5->q = "Which is probably the most important thing about keyhole operations?";

$E1_1_5->e1->aw = "C. He looks at the picture on a large screen.";
$E1_1_5->e2->aw = "C. There’s a laser light at the end of the wire.";
$E1_1_5->e3->aw = "B. The cut is much smaller than in a traditional operation.";
$E1_1_5->e4->aw = "A. The nurse moves the camera around the patient’s body.";
$E1_1_5->e5->aw = "B. The patient is in less danger.";
...
$E1_1_5->e1->choice->a = "A. He looks through a long, thin wire.";
$E1_1_5->e1->choice->b = "B. He looks inside the body through the keyhole.";
$E1_1_5->e1->choice->c = "C. He looks at the picture on a large screen.";
$E1_1_5->e2->choice->a = "A. There’s a sharp knife at the end of the wire.";
$E1_1_5->e2->choice->b = "B. The end of the wire is very sharp and can cut into the body.";
$E1_1_5->e2->choice->c = "C. There’s a laser light at the end of the wire.";
$E1_1_5->e3->choice->a = "A. The doctor uses a special key to make the cut.";
$E1_1_5->e3->choice->b = "B. The cut is much smaller than in a traditional operation.";
$E1_1_5->e3->choice->c = "C. The long, thin wire has a camera at the end of it.";
$E1_1_5->e4->choice->a = "A. The nurse moves the camera around the patient’s body.";
$E1_1_5->e4->choice->b = "B. The doctor moves the camera around the patient’s body.";
$E1_1_5->e4->choice->c = "C. The patient moves the camera around his body himself.";
$E1_1_5->e5->choice->a = "A. The patient pays less money.";
$E1_1_5->e5->choice->b = "B. The patient is in less danger.";
$E1_1_5->e5->choice->c = "C. The patient spends less time with the doctor.";
...
$E2_1_5->e1->q = "How can the doctor look inside a patient’s body using the long, thin wire?";
$E2_1_5->e2->q = "What does the nurse do during keyhole operations?";
$E2_1_5->e3->q = "Why can the patient go home earlier after keyhole surgery?";
