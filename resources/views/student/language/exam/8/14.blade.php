...
<script>
    // no space answer
    const answer1 = ['conducted'];
    const answer2 = ['percentage', 'proportion'];
    const answer3 = ['highest'];
    const answer4 = ['transplantation', 'transplants'];
    const answer5 = ['If'];
    const answer6 = ['while', 'but', 'although', 'whereas'];
    const answer7 = ['next', 'following', 'subsequent'];
    const answer8 = ['took'];
    const answer9 = ['Increasing', 'rising', 'growing', 'rising'];
    const answer10 = ['fall', 'decrease', 'reduction'];
    const answer11 = ['decade'];
    const answer12 = ['Slightly', 'just', 'moderately'];
