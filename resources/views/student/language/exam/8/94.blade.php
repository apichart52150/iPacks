...
<script>
    // no space answer
    const answer1 = ['invented'];
    const answer2 = ['transformed', 'developed', 'changed', 'improved'];
    const answer3 = ['physical'];
    const answer4 = ['compared'];
    const answer5 = ['is', 'measures'];
    const answer6 = ['width'];
    const answer7 = ['namely'];
    const answer8 = ['listening'];
    const answer9 = ['smaller', 'reduced'];
    const answer10 = ['latter'];
    const answer11 = ['Turning', 'Moving'];
    const answer12 = ['addition'];
    const answer13 = ['dial', 'access', 'reach'];
    const answer14 = ['emails', 'messages'];
