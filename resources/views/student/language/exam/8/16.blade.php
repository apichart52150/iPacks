...
<script>
    // no space answer
    const answer1 = ['stages'];
    const answer2 = ['distinct', 'different'];
    const answer3 = ['carried'];
    const answer4 = ['consists'];
    const answer5 = ['where'];
    const answer6 = ['turn'];
    const answer7 = ['final', 'last', 'third', 'next'];
    const answer8 = ['exceeding'];
    const answer9 = ['remove', 'clean'];
    const answer10 = ['sand'];
    const answer11 = ['latter'];
    const answer12 = ['following', 'after'];
