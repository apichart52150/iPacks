<style>
    ...
    @php
        $q1 = "The population of China is";
        $q11 = "than the population of Thailand.";
        $q111 = array(
            'big',
            'bigger',
            'biggest',
        ...
        $q6 = "Toyota sold the";
        $q66 = "number of cars throughout Asia.";
        $q666 = array(
            'high',
            'higher',
            'highest',
        ...
        $q7 = "The";
        $q77 = "building in the world is in Dubai.";
        $q777 = array(
            'high',
            'higher',
            'highest',
        ...
        $q10 = "This test was more";
        $q100 = "than the other one.";
        $q1000 = array(
            'difficult',
            'difficulter',
            'most difficult',
