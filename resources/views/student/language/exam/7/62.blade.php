...
@php
    $q1 = "The pictures show two aircraft, the Boeing 787 and the Airbus 380, and the table gives";
    $q2 = "about specifications for the two airplanes. Overall, it can be seen that there are significant differences between the two aircraft in terms of physical appearance and performance. Starting with appearance, the Airbus 380 is longer than the Dreamliner; the former is 73 metres";
    $q3 = "while the latter is 57 metres in";
    $q4 = ". The wing span of the Airbus is also wider than the Dreamliner. The Airbus wing span is 80 metres wide, while the Dreamliner is 60 metres in";
    $q5 = ". The Airbus is also higher than the Dreamliner. The former is 24 metres high, while the";
    $q6 = "has a";
    $q7 = "of just 17 metres. With regard to performance, there are also a number of differences. The most significant difference is the passenger capacity. The";
    ...
    $q11 = "that of the Airbus, with ranges of 15,200 and 15,400 kilometres respectively. In addition, when it comes to speed, both aircraft can travel at similar speeds of 900 kilometres per";
            ...
            <div class="row justify-content-center mb-2">
                <div class="col-md-6">
                    <div class="border border-dark px-2 text-center">
                        <h5></h5>
                        <img src="{{ asset('public/img_lang/gap1/gap1_6.jpg') }}" class="img-fluid mb-2" alt="Responsive image">
                    </div>
                </div>
                <div class="col-md-6">
...
<script>
    ...
    const answer2 = ['long'];
    const answer3 = ['length'];
    const answer4 = ['width','size'];
    const answer5 = ['Dreamliner','Boeing','latter'];
    const answer6 = ['height'];
    const answer7 = ['Dreamliner','Boeing'];
    const answer8 = ['Airbus'];
    const answer9 = ['4', 'four'];
    const answer10 = ['than'];
    const answer11 = ['hour'];
