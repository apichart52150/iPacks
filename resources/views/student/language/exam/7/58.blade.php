...
@php
    $start = "The line-graphs give details of the percentage of adolescents who owned cd players, laptop computers and mobile phones during the period 1980 to 2010. Overall, it can be seen that the popularity of cd players";
    ...
    $end = ", continued to rise, with almost 100% ownership by 2010.";
@endphp
<div class="row">
    <div class="col-md-12">
            ...
            <div class="row justify-content-center mb-2">
                <div class="col-md-6">
                    <div class="border border-dark px-2 text-center">
                        ...
                        <img src="{{ asset('public/img_lang/p_12.jpg') }}" class="img-fluid mb-2" alt="Responsive image">
                    </div>
                </div>
                <div class="col-md-6">
...
<script>
    ...
    const answer1 = ['decreased', 'fell', 'dropped', 'reduced'];
    const answer2 = ['increased', 'rose', 'grew'];
    const answer3 = ['beginning', 'start'];
    const answer4 = ['most'];
    const answer5 = ['than'];
    const answer6 = ['rise','increase'];
    const answer7 = ['fall','decrease','reduction','drop'];
    const answer8 = ['at'];
    const answer9 = ['rise', 'increase'];
    const answer10 = ['lowest'];
    const answer11 = ['drop', 'fall', 'decrease'];
    const answer12 = ['however','though'];
