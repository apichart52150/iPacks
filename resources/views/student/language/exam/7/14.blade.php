                ...
                <div class="col-md-12">
                    <div class="border border-dark px-2 text-center">
                        <h5>The tables show world population between 1950 and 2050 and the distribution of population by
                            region.</h5>
                        <a href="{{ asset('public/img_lang/gap1/gap1_14.jpg') }}" class="image-popup" title="{{$pageTitle['topic']}}">
                                <img src="{{ asset('public/img_lang/gap1/gap1_14.jpg') }}" class="img-fluid" alt="work-thumbnail">
                                </a>
                            </div>
                </div>
            </div>
