            ...
            <div class="row justify-content-center mb-2">
                <div class="col-md-6">
                    <div class="border border-dark px-2 text-center">
                        ...
                        <img src="{{ asset('public/img_lang/p_110.jpg') }}" class="img-fluid mb-2" alt="Responsive image">
                    </div>
                </div>
                <div class="col-md-6">
...
<script>
    ...
    const answer1 = ['most'];
    const answer2 = ['respectively'];
    const answer3 = ['20%','one-fifth'];
    const answer4 = ['Half'];
    const answer5 = ['10%','one-tenth'];
    const answer6 = ['more','greater', 'higher'];
    const answer7 = ['least'];
    const answer8 = ['up'];
    const answer9 = ['older'];
    const answer10 = ['less'];
