...
"q2" => "rain fell in one city from 2005 until 2011. Figures are given in millimetres. The line-graph shows the average
temperature during those years. Overall, it can be",
...
"q6" => "to around 750 mm. The downward trend continued over the next 2 years, with figures of approximately 600 and 450
mm",
            ...
            <div class="row justify-content-center mb-2">
                <div class="col-md-12">
                    <div class="border border-dark px-2 text-center">
                        <h5>The bar-chart shows the rainfall in a particular city over a 6-year period (measured in mm),
                            and the line-graph shows the average temperature over the same period (in degrees Celsius).
                        </h5>
                        <a href="{{ asset('public/img_lang/gap1/gap1_20.jpg') }}" class="image-popup"
                            title="{{$pageTitle['topic']}}">
                            <img src="{{ asset('public/img_lang/gap1/gap1_20.jpg') }}" class="img-fluid"
                                alt="work-thumbnail">
                        </a>
                    </div>
                </div>
