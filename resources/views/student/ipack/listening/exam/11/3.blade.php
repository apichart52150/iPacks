...
$E1_1_5->e1->q = "What does the color ‘red’ NOT mean?";
$E1_1_5->e2->q = "What does ‘envy’ mean?";
$E1_1_5->e3->q = "Blues music is usually…";
$E1_1_5->e4->q = "If someone is afraid, what could we call them?";
$E1_1_5->e5->q = "Why does the woman getting married wear white?";

$E1_1_5->e1->aw = "C. Sadness";
$E1_1_5->e2->aw = "A. Jealousy";
$E1_1_5->e3->aw = "A. sad music.";
$E1_1_5->e4->aw = "C. Both the above";
$E1_1_5->e5->aw = "A. To show she is a good woman";
...
$E1_1_5->e1->choice->a = "A. Anger";
$E1_1_5->e1->choice->b = "B. Danger";
$E1_1_5->e1->choice->c = "C. Sadness";
$E1_1_5->e2->choice->a = "A. Jealousy";
$E1_1_5->e2->choice->b = "B. Anger";
$E1_1_5->e2->choice->c = "C. Sadness";
$E1_1_5->e3->choice->a = "A. sad music.";
$E1_1_5->e3->choice->b = "B. angry music.";
$E1_1_5->e3->choice->c = "C. both the above.";
$E1_1_5->e4->choice->a = "A. Yellow";
$E1_1_5->e4->choice->b = "B. Chicken";
$E1_1_5->e4->choice->c = "C. Both the above";
$E1_1_5->e5->choice->a = "A. To show she is a good woman";
$E1_1_5->e5->choice->b = "B. Because the man wears black";
$E1_1_5->e5->choice->c = "C. To show the man is a bad person";
...
$E2_1_5->e1->q = "Give examples of different ‘feelings’ from the passage.";
$E2_1_5->e2->q = "What color are most signs showing danger?";
$E2_1_5->e3->q = "Which color shows sadness?";
$E2_1_5->e4->q = "Which color means ‘evil’?";
$E2_1_5->e5->q = "Why does the man getting married wear black?";

$E2_1_5->e1->aw = "fear, anger, sadness and jealousy or envy";
$E2_1_5->e2->aw = "red";
$E2_1_5->e3->aw = "blue";
$E2_1_5->e4->aw = "black";
