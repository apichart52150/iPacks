...
$E1_1_5->e1->q = "Which is the longest part of the tarsier?";
$E1_1_5->e2->q = "Which of these does the tarsier NOT eat?";
$E1_1_5->e3->q = "Why does the tarsier sleep in a high tree during the day?";
$E1_1_5->e4->q = "Which of these is TRUE?";
$E1_1_5->e5->q = "Why do the people in Indonesia and the Philippines call it ‘hantu’?";

$E1_1_5->e1->aw = "B. Its tail";
$E1_1_5->e2->aw = "A. Leaves";
$E1_1_5->e3->aw = "C. It’s safe there.";
$E1_1_5->e4->aw = "B. The tarsier has large eyes.";
$E1_1_5->e5->aw = "C. We don’t know";
...
$E1_1_5->e1->choice->a = "A. Its body";
$E1_1_5->e1->choice->b = "B. Its tail";
$E1_1_5->e1->choice->c = "C. Its feet";
$E1_1_5->e2->choice->a = "A. Leaves";
$E1_1_5->e2->choice->b = "B. Fish";
$E1_1_5->e2->choice->c = "C. Insects";
$E1_1_5->e3->choice->a = "A. It looks for food there.";
$E1_1_5->e3->choice->b = "B. It has long feet which help it to jump from tree to tree.";
$E1_1_5->e3->choice->c = "C. It’s safe there.";
$E1_1_5->e4->choice->a = "A. The tarsier is brown in color.";
$E1_1_5->e4->choice->b = "B. The tarsier has large eyes.";
$E1_1_5->e4->choice->c = "C. The tarsier has a very big brain.";
$E1_1_5->e5->choice->a = "A. It hunts at night.";
$E1_1_5->e5->choice->b = "B. It has big eyes.";
$E1_1_5->e5->choice->c = "C. We don’t know";
...
$E2_1_5->e1->q = "How long is the tarsier from one end to the other?";
$E2_1_5->e2->q = "How heavy is the tarsier?";
$E2_1_5->e3->q = "When does it hunt for food?";
...
$E2_1_5->e5->aw = "in Indonesia and the Philippines";
